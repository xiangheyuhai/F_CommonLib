...
#ifdef F_STM32_F4
#include "math.h"
#include "./F_TOUCH_Drv_FT5206/F_TOUCH_Drv_FT5206.h"
#include "./F_TOUCH_Drv_GT9147/F_TOUCH_Drv_GT9147.h"
#include "./F_TOUCH_Drv_OTT2001A/F_TOUCH_Drv_OTT2001A.h"
#include "./F_TOUCH_Drv_24CXX/F_TOUCH_Drv_24CXX.h"
#include "./F_TOUCH_Drv_24CXX/F_TOUCH_Drv_24CXX_IIC.h"
#include "../F_LCD_480/F_LCD_480.h"
...
u16 TP_Read_AD(u8 CMD)
{
	...
	F_HAL_Delay_us(6);//ADS7846的转换时间最长为6us
	TCLK=0;
	F_HAL_Delay_us(1);
	TCLK=1;		//给1个时钟，清除BUSY
	F_HAL_Delay_us(1);
