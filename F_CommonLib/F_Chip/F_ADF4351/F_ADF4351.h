...
//引脚定义
//读取
#define ADF4351_INPUT_DATA_Pin GPIO_PIN_0
#define ADF4351_INPUT_DATA_GPIO_Port GPIOD

//写入
#define ADF4351_CLK_Pin GPIO_PIN_1
#define ADF4351_CLK_GPIO_Port GPIOD

#define ADF4351_OUTPUT_DATA_Pin GPIO_PIN_0
#define ADF4351_OUTPUT_DATA_GPIO_Port GPIOD
